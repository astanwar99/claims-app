...
const welcomeScreen = WelcomeScreen.id;
const loginScreen = LoginScreen.id;
const registrationScreen = RegistrationScreen.id;
const claimUserScreen = ClaimUserScreen.id;
const claimAdminScreen = ClaimAdminScreen.id;
const claimForm = ClaimForm.id;
